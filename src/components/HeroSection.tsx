...
const HeroSection = () => {
  return (
    <section className="relative w-full min-h-screen flex items-center justify-center p-4 md:p-6">
      {/* Main Card Container */}
      <div className="hero-card relative w-full max-w-[1400px] h-[92vh] overflow-hidden shadow-2xl">
